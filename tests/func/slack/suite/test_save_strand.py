...
class TestSaveStrand(TestDmFixtures):
    ...
    def test_save_installed_user(self, installed_user: User, slack_client_class, strand_api_client,
        ...
        """Forward the pasted message to Strand API, and send the user the metadata dialog"""
        ...
        assert installed_user.strand_user_id in strand_api_client.mutate.call_args[1]['operation_definition']
        assert installed_user.agent.strand_team_id in strand_api_client.mutate.call_args[1]['operation_definition']

...
from src.blueprints.slackapps.tokens.SlackApplicationInstallation import SlackApplicationInstallation
...
api.add_resource(SlackApplicationInstallation, '/slackapplicationinstallation')

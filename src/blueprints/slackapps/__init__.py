...
from src.blueprints.slackapps.installations.SlackApplicationInstallationResource import SlackApplicationInstallationResource
...
api.add_resource(SlackApplicationInstallationResource, '/installation')

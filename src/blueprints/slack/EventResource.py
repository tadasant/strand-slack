...
from src.command.ForwardReplyCommand import ForwardReplyCommand
            ...
            if event_request.is_verification_request:
                ...
                if event_request.event.item.is_message and not event_request.event.item.hidden:
                    ...
                    if event_request.event.item.channel == discuss_channel_id:
                        ...
                        if event_request.event.item.is_reply:
                            command = ForwardReplyCommand(slack_client_wrapper=current_app.slack_client_wrapper,

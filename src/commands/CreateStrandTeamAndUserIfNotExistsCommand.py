...
class CreateStrandTeamAndUserIfNotExistsCommand(Command):
    """
    ...
    def execute(self, session):
        ...
        command = CreateStrandUserIfNotExistsCommand(slack_team_id=self.slack_team_id, slack_user_id=self.slack_user_id,

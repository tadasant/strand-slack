...
class Installation(Base):
    ...
    scope = Column(String, nullable=False, length=256)

    # 0..1 <--> 1
    installer_slack_user_id = Column(String, primary_key=True, length=16)
    installer_agent_slack_team_id = Column(String, primary_key=True, length=16)
